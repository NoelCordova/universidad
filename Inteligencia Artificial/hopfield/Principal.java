...
class Principal { 
    public static void main (String[] args) {
        ...
        **************************************************/
        ...
        // Declaracion de la Matriz de Patrones P de la forma E[M] = [e1,.., eN]
        int[][]E = new int[M][N];
        ...
        **************************************************/
        ...
        la formula W = Sum (TE . E - I) donde Sum es la sumatoria
        de TE (matriz traspuesta del patron de entrada E)
        por la entrada E menos la matriz identidad I
        ...
        ***********************************************/
        ...
        //Declaracion de la Matriz de entrada Ent de la forma Ent = [e1,.., eN]
        int[][]Ent = new int[1][N];
